#ifndef GOL_COMMAND_OPTION_DELAYMS_HPP
#define GOL_COMMAND_OPTION_DELAYMS_HPP
...
namespace GOL
{
    class CommandOptionDelayMs : public CommandOption
    {
        public:
            CommandOptionDelayMs()
                : CommandOption{"-dms", "--delay-ms", "set time for each generation in ms.", 2}
            {}
